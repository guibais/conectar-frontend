        ...
        {Array.from({ length: 5 }).map((_, index) => (
          <div key={index} className="px-6 py-4 border-b border-gray-100 last:border-b-0">
            <div className="flex items-center space-x-4">
              <div className="h-4 bg-gray-200 rounded w-1/4" aria-hidden="true"></div>
              <div className="h-4 bg-gray-200 rounded w-1/3" aria-hidden="true"></div>
              <div className="h-4 bg-gray-200 rounded w-1/6" aria-hidden="true"></div>
              <div className="h-4 bg-gray-200 rounded w-1/5" aria-hidden="true"></div>
            </div>
          </div>
        ))}
      </div>
