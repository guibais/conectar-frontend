...
### ✅ **Tela de Login**
- Design idêntico ao screenshot fornecido
- Validação de formulário com Zod
- Autenticação simulada com credenciais de teste
...
- Filtros expansíveis com busca por nome, CNPJ, status e conecta+
- Tabela responsiva com dados dos clientes
- Botão "Novo" para criar clientes
- Navegação para edição ao clicar em um item
- Paginação e loading states

### ✅ **Tela de Cadastro/Edição de Clientes**
- Sistema de abas (Dados Cadastrais, Informações Internas, Usuários)
- Formulário completo da aba "Dados Cadastrais"
- Validação de campos obrigatórios
- Integração com API ViaCEP para preenchimento automático de endereço
- Diferenciação entre criação (POST) e edição (PUT)

### ✅ **Tela de Perfil do Usuário**
- Visualização de informações do usuário logado
- Edição de nome e senha
- Informações da conta (role, data de criação)
- Validação de formulário

### ✅ **Arquitetura e Segurança**
- Gerenciamento de estado com Zustand
- Armazenamento seguro com js-cookie
- Rotas protegidas baseadas em autenticação e roles
